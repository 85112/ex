...
<form name="form1" method="POST" action="band_verwijder_verwerk.php" class="form">
      ...
      <div class="input-container ic2">
        <input type="text" name="Naam" value="<?php echo $rij['Naam'] ?>" disabled class="input"></p>
        <div class="cut"></div>
        <label for="Bandnaam" class="placeholder">Bandnaam</label>
      </div>
<div class="input-container ic2">
       <input type="text" name="Land" value="<?php echo $rij['Land'] ?>" disabled class="input"></p>
        <div class="cut"></div>
